...
module.exports = {
  ...
  userPrincipalName: process.env.USER_PRINCIPLE_NAME || 'SploeCyber@yvngc.onmicrosoft.com',
  ...
  protectedRoutes: ['/Private/PreEng', '/Private/Photo', '/Private/Musketeers'],
